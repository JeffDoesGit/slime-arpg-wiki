...
The tree screen (P) shows one region per tab, node icons on the move nodes, the point pool, and Respec for testing. Everything here is provisional on D-8.2, D-3.5 and, for the control verbs, D-3.7.
